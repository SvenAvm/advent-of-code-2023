...
symbol_starting_locations = utils.find_all_symbol_starting_point_locations(test1_grid, utils.symbol_regex)
asterix_starting_locations = utils.find_all_symbol_starting_point_locations(test1_grid, utils.asterix_regex)
number_starting_locations = utils.find_all_symbol_starting_point_locations(test1_grid, utils.numbers_regex)

print(f" Symbol locations: {symbol_starting_locations}")
print(f" Asterix locations: {asterix_starting_locations}")
